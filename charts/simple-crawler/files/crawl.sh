...
print_usage() {
  ...
  echo
  echo "Usage: $(dirname "$0")/$(basename "$0") --sitemap=\"https://example.com/sitemap.xml\" [--wait=1]"
...
# Phase 2: Crawl all collected URLs
echo "Phase 2: Crawling all collected URLs with a $WAIT_TIME second wait time"
